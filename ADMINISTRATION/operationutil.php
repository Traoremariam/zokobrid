...
<body style="border: 2px solid black ">
	...
	<div class="m-5"style="text-align: center; font-weight: bold;font-size: 25px; margin-top: 20px;">OPERATIONS SUR L’UTILISATEUR   </div>
	<center >
 ...
 <form class="m-3 was-validated m-5" style="color: #ff4500; font-size: 20px;" >
			 	...
			 	<div class="row">
			 	 ...
			 	 <div class=" col-md-6,form-row align-items-center">
    ...
    <div class="mt-3">Bloquer l’utilisateur : </div>
...
<div class="custom-control custom-radio custom-control-inline m-3">
  ...
  <label class="custom-control-label" for="customRadioInline2">NON</label>
	 ...
	 <button type="submit" class="btn btn-primary m-5" style="background:#ff4500;width: 300px;">MODIFIER  </button>
			</form>
