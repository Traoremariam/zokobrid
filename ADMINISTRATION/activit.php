...
<body style="border: 2px solid black ">
	...
	<div class="row text-center" style="background: #ff4500; ">
				...
				<div class="col-6">  <a href="" style="color: white"> INTELLIGENCE </a></div>
				<div class="col-6"> <a href="" style="color: white">  LES ECHECS  </a></div>

	</div>
	<div style="text-align: center; font-weight: bold;font-size: 20px; margin-top: 40px;">LES ACTIVITES (10)  </div>
	<div class="row text-center m-5">
		<div class="col-3 m-5 " style="background: #ff4500; height: 40px; margin-left: 20px;"> <a href="" style="color: white ; ">Toutes les Activités</a> </div>
		<div class="col-3 m-5" style="background: #ff4500; height: 40px; margin-left: 20px;"> <a href="" style="color: white ; ">Administration</a> </div>
		<div class="col-3 m-5" style="background: #ff4500; height: 40px; margin-left: 20px;"> <a href="" style="color: white ; ">Ajouter une intelligence</a> </div>
	</div>
	 	<center>
	<table class="table table-bordered text-center mt-3" style="width: 85%;">
        ...
        <tbody>
          ...
          </tr>Editeur : Kouakou Modification de donnée d’intelligence 
